...
function get_todos() {
    ...
    var todos = new Array;
    /*this pulls the task that saved in the web browser*/
...
function add() {
    ...
    var todos = get_todos();
    /*This add a new task the end of the array*/
    todos.push(task);
    /*this convrets the task input to a JSON string*/
...
function show() {
    ...
    for (var i = 0; i < todos.length; i++) {
        /*this also diplays the task as a list and creates the button with the "x"*/
...
/*This displays the inputed task when the 'Add Item' butoon is clicked*/
